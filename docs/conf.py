# -*- coding: utf-8 -*-
#
# pytest-ml documentation build configuration file, created by
...
project = u'pytest-ml'
copyright = u'2015, Carlo Mazzaferro'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-ml Documentation',
     [author], 1)
]
